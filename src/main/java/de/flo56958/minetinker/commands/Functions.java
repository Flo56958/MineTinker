...
class Functions {
     ...
     * @param sender The sender that runs the command
     */
     ...
     * @param player The player to add exp for
     ...
     * @param player The player to have the item renamed
     * @param args command input of the player - parsed down from onCommand()
     */
     ...
     * @param player The player to have the mod removed for
     * @param args command input of the player - parsed down from onCommand()
     */
     ...
     * @param player The player to have the mod added for
     * @param args command input of the player - parsed down from onCommand()
     */
     ...
     * @param player The player to have the durability set for
     * @param args command input of the player - parsed down from onCommand()
     */
     ...
     * @param player The player to have the item converted
     * @param args command input of the player - parsed down from onCommand()
     */
     ...
     * @param player The player to have the mod item given to
     * @param args command input of the player - parsed down from onCommand()
     */
