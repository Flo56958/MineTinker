...
public class Reinforced extends Modifier implements Craftable {
    ...
    public void registerCraftingRecipe() {
        try {
            ...
            String top = recipesConfig.getString("Recipes.Reinforced.Top");
            String middle = recipesConfig.getString("Recipes.Reinforced.Middle");
            String bottom = recipesConfig.getString("Recipes.Reinforced.Bottom");
            ConfigurationSection materials = recipesConfig.getConfigurationSection("Recipes.Reinforced.Materials");
