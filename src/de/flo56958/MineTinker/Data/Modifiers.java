...
public class Modifiers {
    ...
    public static final ItemStack KNOCKBACK_MODIFIER = ItemGenerator.itemEnchanter(Material.TNT, ChatColor.GRAY + Main.getPlugin().getConfig().getString("Modifiers.Knockback.name_modifier"), 1, Enchantment.KNOCKBACK, 1);
